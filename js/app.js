 ...
 */            (function(window, factory) {
    ...
    (() => {
        ...
        if (document.querySelector(".page-home__slider")) new Swiper(".swiper", {
            navigation: {
                prevEl: ".swiper-button-prev",
                nextEl: ".swiper-button-next"
            },
        ...
        if (spollersArray.length > 0) {
            ...
            function initSpollerBody(spollersBlock, hideSpollerBody = true) {
                ...
                if (spollerTitles.length > 0) spollerTitles.forEach((spollerTitle => {
                    if (hideSpollerBody) {
                        ...
                        if (!spollerTitle.classList.contains("_active")) spollerTitle.nextElementSibling.hidden = true;
                    } else {
            ...
            function setSpollerAction(e) {
                ...
                if (el.hasAttribute("data-spoller") || el.closest("[data-spoller]")) {
                    ...
                    if (!spollersBlock.querySelectorAll("._slide").length) {
                        if (oneSpoller && !spollerTitle.classList.contains("_active")) hideSpollersBody(spollersBlock);
                        spollerTitle.classList.toggle("_active");
                        spoller_slideToggle(spollerTitle.nextElementSibling, 500);
                    }
                    e.preventDefault();
                }
            }
            function hideSpollersBody(spollersBlock) {
                ...
                if (spollerActiveTitle) {
                    ...
                    spoller_slideUp(spollerActiveTitle.nextElementSibling, 500);
                }
            }
        }
        let spoller_slideUp = (target, duration = 500, showmore = 0) => {
        ...
        let spoller_slideDown = (target, duration = 500, showmore = 0) => {
            if (!target.classList.contains("_slide")) {
                target.classList.add("_slide");
        ...
        let spoller_slideToggle = (target, duration = 500) => {
            if (target.hidden) return spoller_slideDown(target, duration); else return spoller_slideUp(target, duration);
        };
        window["FLS"] = true;
        isWebp();
        menuInit();
